            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <h3 className="text-xl font-bold text-blue-400 mb-4">AcademicPro</h3>
                        <p className="text-sm text-gray-400">Your platform for academic excellence and group collaboration.</p>
                    </div>
                </div>
                
                <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-500">
                    &copy; {new Date().getFullYear()} AcademicPro. All rights reserved.
                </div>
            </div>
        </footer>
    );
